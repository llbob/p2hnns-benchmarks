...
def create_hyperplanes_psm(X: np.ndarray, n_hyperplanes: int = 1000) -> Tuple[np.ndarray, np.ndarray]:
    """
    random point sample distance (psm) ?
...
#     """
#     (grn) method to create hyperplanes and biases.
...
DATASETS: Dict[str, Callable[[str], None]] = {
    # ========================================================================
    # Here are datasets that are used as testers - all '20k' covers datasets of 20k points only
    ...
    # ========================================================================
    # Here are the datasets that are used to demonstrate the hyperplane methods -> for this consider the branch feature/queries-generation-wrapper                              
    # 25 dims - 20k points
