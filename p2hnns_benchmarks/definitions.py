...
def instantiate_algorithm(definition: Definition) -> BaseANN:
    ...
    Note:
        ...
        p2hnns_benchmarks/algorithms/*/module.py.
    """
...
def get_config_files(base_dir: str = "p2hnns_benchmarks/algorithms") -> List[str]:
...
def load_configs(point_type: str, base_dir: str = "p2hnns_benchmarks/algorithms") -> Dict[str, Any]:
...
def _get_definitions(base_dir: str = "p2hnns_benchmarks/algorithms") -> List[Dict[str, Any]]:
...
def _get_algorithm_definitions(point_type: str, distance_metric: str, base_dir: str = "p2hnns_benchmarks/algorithms") -> Dict[str, Dict[str, Any]]:
    ...
    metric. For example, `p2hnns_benchmarks.algorithms.nmslib` has two definitions for euclidean float
    ...
    ```
    {
        'SW-graph(nmslib)': {
            ...
            "disabled": false,
            "docker_tag": p2hnns-benchmarks-nmslib,
            ...
        },
        'SW-graph(nmslib)': {
...
def list_algorithms(base_dir: str = "p2hnns_benchmarks/algorithms") -> None:
    """
    ...
    Args:
        base_dir (str, optional): The base directory where the algorithms are stored.
                                  Defaults to "p2hnns_benchmarks/algorithms".
    """
...
def get_definitions(
    ...
    count: int = 10,
    base_dir: str = "p2hnns_benchmarks/algorithms"
) -> List[Definition]:
