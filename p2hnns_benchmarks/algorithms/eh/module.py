...
class EH(BaseANN):
    ...
    def index(self, X):
        ...
        self._eh_index.preprocess(n, d, self._m_hashers, self._l_hash_tables, self._interval_ratio, data_array)
    ...
    def query(self, q, b, n):
        ...
        results, self._num_lin_scans = self._eh_index.search(n, self._candidates, q_to_pass)
        return results
    ...
    def __str__(self):
        return "EH(m_hashers=%d, l_hash_tables=%d, candidates=%d)" % (self._m_hashers, self._l_hash_tables, self._candidates)