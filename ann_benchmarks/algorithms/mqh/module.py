...
class BT_MQH(BaseANN):
    ...
    def set_query_arguments(self, candidates=100, initial_topk=100, l0=3, delta=0.5, flag=0):
    ...
    def get_memory_usage(self):
        ...
        # Account for both data structures
        return (self._data.nbytes * 2) if hasattr(self, "_data") else 0
...
class MH_MQH(BaseANN):
    ...
    def get_memory_usage(self):
        # Return an estimate of memory usage in bytes
        # Include both MH and MQH structures
        return (self._data.nbytes * 2) if hasattr(self, "_data") else 0
...
class MQH(BaseANN):
    ...
    def set_query_arguments(self, l0=3, delta=0.5, flag=0):
        self._l0 = l0
        self._delta = delta
        self._flag = flag
