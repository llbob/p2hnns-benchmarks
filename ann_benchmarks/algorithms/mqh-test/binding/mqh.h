...
//offset jumps over the memory already written with coarse info and is maintained through the levels. 
int coarse_offset = sizeof(int) + 2 * sizeof(float) + 2 * sizeof(unsigned char);
