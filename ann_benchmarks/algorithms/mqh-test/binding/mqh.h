...
class MQH {
    ...
    public:
        ...
        std::pair<std::vector<Neighbor>, int> query_with_candidates(const std::vector<float>& query_pt, int k, float u, int l0, float delta, int query_flag, std::vector<int>& external_candidates);
...
std::pair<std::vector<Neighbor>, int> MQH::query_with_candidates(const std::vector<float>& query_pt, int k, float u, int l0, float delta, int query_flag, std::vector<int>& external_candidates) {
